                ...
                <tr>
                     <td>
                        @forelse ($item->item_images as $img)
                            <img src="{{ asset('storage/' . $img) }}" width="60" class="me-1 mb-1 rounded">
                        @empty
                            <img src="{{ asset('images/default-item.png') }}" alt="Default Image" width="80">
                        @endforelse
                    </td>
        ...
        @foreach ($items as $item)
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    @else
                        <img src="{{ asset('images/default-item.png') }}" class="card-img-top" alt="Default Image">
                    @endif
                    <div class="card-body">
