    ...
    <div class="password-shell">
        ...
        <section class="password-card">
            <div class="password-card-header">
                <div>
                   <h2>User Profile</h2>
                    <p>Review your current details and enter the username or new password you want to use.</p>                    <p></p>
                </div>
            </div>
            ...
            <form action="{{ route('franchisee-staff.password.update') }}" method="POST" class="password-form">
                ...
                <div class="password-actions">
                    ...
                    <a href="{{ route('franchisee-staff.account-center') }}" class="password-secondary-link">
