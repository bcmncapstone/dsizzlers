...
<div class="stock-edit-page">
    <div class="stock-edit-shell">
        <div class="stock-edit-header-card">
            ...
            <a href="{{ route('franchisee.stock.index') }}" class="stock-edit-back-link">
                Back to Stock
            </a>
        </div>
        ...
        <div class="stock-edit-grid">
            ...
            <section class="stock-edit-main">
                <section class="stock-edit-card">
                    ...
                    <form method="POST" action="{{ route('franchisee.stock.update', $stock->stock_id) }}" id="stockForm" class="stock-edit-form">
                        @csrf
                        ...
                        <div class="stock-edit-actions">
                            <a href="{{ route('franchisee.stock.index') }}" class="stock-edit-btn-secondary">Cancel</a>
