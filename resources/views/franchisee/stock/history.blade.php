            ...
            <div class="p-6">
                ...
                <form method="GET" action="{{ route('franchisee.stock.history') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-end">
                        <button type="submit" 
                                class="w-full inline-flex justify-center items-center px-4 py-2 bg-[#9396DB] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#9396DB] focus:bg-[#9396DB] active:bg-[#9396DB] focus:outline-none focus:ring-2 focus:ring-[#9396DB] focus:ring-offset-2 transition ease-in-out duration-150">
                            <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
