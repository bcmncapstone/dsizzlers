    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-start">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Item Inventory</h1>
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('franchisee.stock.staff-orders') }}" 
                           class="inline-flex flex-col items-center px-4 py-3 bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition">
                            ...
                            <span class="text-xs font-semibold text-white">Staff Orders</span>
                        </a>
                        <a href="{{ route('franchisee.stock.history') }}" 
                           class="inline-flex flex-col items-center px-4 py-3 bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition">
                            <svg class="h-6 w-6 text-white mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-xs font-semibold text-white">View History</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Stock Management Note</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Stock automatically increases when you receive deliveries from the franchisor</li>
                            <li>You can manually adjust stock to reflect sales, spoilage, or other adjustments</li>
                            <li>Click "Adjust Stock" to update quantities</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
            <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">Current Stock Levels</h2>
                            ...
                            @forelse($stocks as $stock)
                                <tr class="hover:bg-gray-50 {{ $stock->status === 'out_of_stock' ? 'bg-red-50' : ($stock->status === 'low_stock' ? 'bg-yellow-50' : '') }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('franchisee.stock.edit', $stock->stock_id) }}" 
