...
<div class="orders-page">
    <div class="orders-container">
        ...
        <div class="filter-section">
            <form method="GET" action="{{ route('franchisee.orders.index') }}" class="filter-form">
        ...
        @if($selectedStatus !== '')
            <div class="alert alert-info">
                ...
                <a href="{{ route('franchisee.orders.index', ['per_page' => $selectedPerPage]) }}" style="margin-left: 8px;">Clear</a>
            </div>
        @endif
                                    ...
                                    <div class="orders-items">
                                        @foreach($order->orderDetails as $detail)
                                            <div class="orders-item-line">
                                                {{ $detail->item->item_name ?? 'Unknown Item' }} x {{ $detail->quantity }}
                                            </div>
                                        @endforeach
                                    </div>
                                </td>
