...
<head>
    ...
    <title>Welcome - D Sizzlers</title>
                ...
                <form method="POST" action="{{ route('login.unified') }}" class="login-form" id="loginForm">
                    ...
                    <div class="login-form-group">
                        ...
                        <div class="password-toggle-group">
                            <input type="password" id="password" name="password" class="login-input password-toggle-input" placeholder="Enter your password" required>
