...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased" style="background-color: #F5F5F5;">
        ...
        @if(auth()->guard('admin')->check() || auth()->guard('franchisee')->check() || auth()->guard('franchisor_staff')->check() || auth()->guard('franchisee_staff')->check())
        <a href="{{ route('communication.index') }}" class="floating-messages-btn" title="Messages">
