<nav class="navbar" data-navbar>
    <div class="navbar-shell">
        <!-- Logo and Brand -->
        <a href="{{ route('franchisee-staff.account-center') }}" class="navbar-brand">
            ...
            <div>
                ...
                <div style="font-size: 10px; opacity: 0.9;">Franchisee Staff Portal</div>
            </div>
        </a>
       ...
       <button type="button" class="navbar-toggle block md:hidden" data-navbar-toggle aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav flex-col md:flex-row md:flex md:static absolute right-0 top-full bg-white md:bg-transparent w-full md:w-auto shadow md:shadow-none z-50 transition-all duration-200 ease-in-out hidden md:flex" data-navbar-menu>
            ...
            <li><a href="{{ route('franchisee-staff.account-center') }}" class="{{ request()->routeIs('franchisee-staff.account-center') || request()->routeIs('franchisee-staff.password*') || request()->routeIs('franchisee-staff.account.*') ? 'active' : '' }}">Account</a></li>
