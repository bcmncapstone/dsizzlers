<nav class="navbar" data-navbar>
    <div class="navbar-shell">
        <!-- Logo and Brand -->
        <a href="{{ route('franchisor-staff.account-center') }}" class="navbar-brand">
        ...
        <ul class="navbar-nav flex-col md:flex-row md:flex md:static absolute right-0 top-full bg-white md:bg-transparent w-full md:w-auto shadow md:shadow-none z-50 transition-all duration-200 ease-in-out hidden md:flex" data-navbar-menu>
            ...
            <li><a href="{{ route('franchisor-staff.account-center') }}" class="{{ request()->routeIs('franchisor-staff.account-center') || request()->routeIs('franchisor-staff.password*') || request()->routeIs('franchisor-staff.account.*') ? 'active' : '' }}">Account</a></li>
            <li>
