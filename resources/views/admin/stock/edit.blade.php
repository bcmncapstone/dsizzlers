...
<div class="stock-edit-page">
    <div class="stock-edit-shell">
        <div class="stock-edit-header-card">
            ...
            <a href="{{ route('admin.stock.index') }}" class="stock-edit-back-link">
                Back to Stock
            </a>
        </div>
        ...
        <div class="stock-edit-grid">
            ...
            <section class="stock-edit-main">
                <section class="stock-edit-card">
                    ...
                    <form method="POST" action="{{ route('admin.stock.update', $item->item_id) }}" id="stockForm" class="stock-edit-form">
                        @csrf
                        ...
                        <div class="stock-edit-field">
                            ...
                            <div class="stock-edit-stepper">
                                ...
                                <input type="number" name="new_quantity" id="new_quantity" value="{{ old('new_quantity', $item->stock_quantity) }}" min="0" required>
                        ...
                        <div class="stock-edit-actions">
                            <a href="{{ route('admin.stock.index') }}" class="stock-edit-btn-secondary">Cancel</a>
