...
<div class="password-page">
    <div class="password-shell">
        ...
        <section class="password-card">
            ...
            <form action="{{ route('franchisor-staff.password.update') }}" method="POST" class="password-form">
                @csrf
                ...
                <div class="password-form-group">
                    ...
                    <input
                        ...
                        value="{{ old('username', auth('franchisor_staff')->user()->astaff_username) }}"
                ...
                <div class="password-actions">
                    ...
                    <a href="{{ route('franchisor-staff.account-center') }}" class="password-secondary-link">
