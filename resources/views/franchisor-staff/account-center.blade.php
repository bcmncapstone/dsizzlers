...
<style>
    .account-center-page {
        ...
        --text-main: #172554;
        --text-muted: #475569;
        --border-soft: rgba(194, 65, 12, 0.14);
        --shadow-soft: 0 24px 60px rgba(15, 23, 42, 0.12);
        padding: 24px 18px 40px;
        background:
            radial-gradient(circle at top left, rgba(251, 191, 36, 0.2), transparent 30%),
...
<div class="account-center-page">
    <div class="account-center-shell">
        <section class="account-center-hero">
            <p class="account-center-kicker">Franchisor Staff Portal</p>
            <h1 class="account-center-title">Account Center</h1>
            <p class="account-center-copy">
                Choose the part of your account you want to manage. Update your contact details or move straight to your security settings without leaving the portal.
            </p>
        </section>

        <div class="account-center-grid">
            <a href="{{ route('franchisor-staff.account.show') }}" class="account-center-card">
                ...
                <p class="account-center-card-copy">
                    Review and edit your email address and phone number from your staff profile page.
                </p>
                <span class="account-center-card-link">Open profile</span>
            </a>

            <a href="{{ route('franchisor-staff.password') }}" class="account-center-card">
                <span class="account-center-card-badge">S</span>
                <h2 class="account-center-card-title">Update Password</h2>
                <p class="account-center-card-copy">
                    Change your username and password using the security form inside the portal.
                </p>
        ...
        <section class="account-center-user">
            <div class="account-center-avatar">{{ strtoupper(substr($user->astaff_username ?? 'A', 0, 1)) }}</div>
            <div>
                <p class="account-center-user-label">Signed in as</p>
                <p class="account-center-user-name">{{ $user->astaff_username }}</p>
                <p class="account-center-user-email">{{ $user->astaff_email }}</p>
            </div>
        </section>
    </div>
</div>
