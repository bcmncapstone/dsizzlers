...
<div class="py-6">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <!-- Account Form -->
        <form action="{{ route('franchisor-staff.account.update') }}" method="POST" class="bg-white shadow-sm sm:rounded-lg p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{ old('email', $user->astaff_email) }}"
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    value="{{ old('contactNo', $user->astaff_contactNo) }}" 
